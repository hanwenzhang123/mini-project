...
const api = require('./api.json');      //require a json module
...
function get(query) {
    ...
    try {       // it is catching malformed url
        const request = https.get(`https://api.wunderground.com/api/${api.key}/geolookup/conditions/q/${query}.json`, response => {
            if (response.statusCode === 200) {
                ...
                // Status Code Error                    //here is the human readable code
            ...
            }               //http.STATUS_CODE only on http not https!!!
